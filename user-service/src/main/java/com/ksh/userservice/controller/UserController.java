...
import com.ksh.userservice.service.UserService;
...
public class UserController {
	...
	@PutMapping("{id}")
	public Mono<ResponseEntity<UserDto>> updateUser(@PathVariable int id, @RequestBody Mono<UserDto> userDotMono){
		return this.service.updateUser(id, userDotMono)
				.map(ResponseEntity::ok)
				.defaultIfEmpty(ResponseEntity.notFound().build());
	}
	@DeleteMapping("{id}")
